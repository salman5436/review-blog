      ...
      <div className="container mx-auto px-6 py-3 md:flex md:justify-between md:items-center">
        ...
        <div className="md:flex items-center">
          <div className="flex flex-col md:flex-row md:mx-6">
            <Link href="/" className="my-1 text-md text-gray-800 hover:text-blue-500 md:mx-4 md:my-0">
              Home
            </Link>
            {session && (
              <div>
                <Link href="/account" className="my-1 text-md text-gray-800 hover:text-blue-500 md:mx-4 md:my-0">
                  Account
                </Link>
                <Link href="/create" className="my-1 text-md text-gray-800 hover:text-blue-500 md:mx-4 md:my-0">
                  Create Review
                </Link>
              </div>
            )}
